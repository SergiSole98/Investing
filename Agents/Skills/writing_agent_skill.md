...
25. **Skill routing:** Cursor skills live in `.cursor/skills/`; Investing agent skills live in `Agents/Skills/`. For new skill specs, read `/Users/ssole/Documents/Agents/skill_spec_generator/skill_spec_generator.md`.
