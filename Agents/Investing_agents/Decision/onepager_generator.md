...
2. Read the following two files:
   - `Analisis/<name>/News/news.md`
   - `Analisis/<name>/Events/events.md`
...
4. Save the completed one-pager to `Analisis/<name>/Decision/onepager.md`.
...
5. Save only under `Analisis/<name>/Decision/`; do not write elsewhere.
...
**To the orchestrator:** one line:
    ...
    Saved: Analisis/<name>/Decision/onepager.md
