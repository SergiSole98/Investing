...
5. Create the folder `Context/Analisis/<name>/Events/` if it does not exist.
6. Write the list to `Context/Analisis/<name>/Events/events.md` using the **File body** format below.
